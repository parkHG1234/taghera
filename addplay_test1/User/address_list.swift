...
class address_list: UIViewController {
    ...
    var addressTitleDelegate : addressTitleDelegate!
    ...
    @IBAction func goToAddressAdd(_ sender: Any) {
...
extension address_list: UITableViewDataSource, UITableViewDelegate, addressAddDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        self.addressTitleDelegate.address_title(address: self.Array_list[indexPath.row].address_title.removingPercentEncoding!)
    }
}
